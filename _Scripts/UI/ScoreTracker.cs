...
public class ScoreTracker : MonoBehaviour
{
    ...
    private void OnEnable() => Victory.PlayerVictory += UpdateScoreboard;

    private void OnDisable() => Victory.PlayerVictory -= UpdateScoreboard;
    #endregion

    void Start() => timer = GameObject.Find("Timer Text").GetComponent<CountdownTimer>();
